...
<body>
   ...
   <?php }
	...
	<form action="edititem" method="post">
      ...
      <input type="text" name="idpenjualan" id="id_penjualan" readonly value="<?php echo $id;?>"><br>
      <label for="tgl">Tanggal penjualan   :</label>
      <input type="text" name="date" id="tgl" readonly value="<?php echo date ("Y-m-d") ?>"><br>
      <label for="cat">merek cat(warna) :</label>
      <input list="cat" name="cat" id="cat" placeholder="masukan nama cat" class="form-control" value="<?php echo $idcat ;?>" ><br>
      <label for="QTY">Quantity :</label>
      <input type="number" name="qty" max="<?php ?>" placeholder="qty" class="form-control" value="<?php echo $qty; ?>"><br>
         <button type="submit" name="simpan" class="">Simpan</button><br><br>
            </div>
    ...
    { $r->subtotal=$r->qty*$r->harga; ?>
    	<tr>
    		...
    		<td><?php echo anchor('transaksipenjualan/edititem/'.$r->id_detail_j.'/'.$r->qty.'/'.$r->id_cat,'edit'); ?></td>
    	</tr>
       <!--  // echo "<tr>
        //     <td>$no</td>
        //     <td>$r->nama_barang</td>
