...
<body>
	<div class="ci">
	    ...
	    <li class="md">	<a class="md" href="pemasok">Data Pemasok</a></li>
	      <li class="md"><a class="md" href="">Data Investor</a></li>
	    <li class="md"><a class="md" href="">Data Akun</a></li>
	    </ul>
	</div>
...
<datalist id="jenis">
	<?php 
		foreach ($rows as $r) { ?>
			<option value="<?php echo $r->id_jenis_cat ;?>"><?php echo $r->nama_jenis_cat; ?></option>
...
<div> 
	...
	<form action="tambahcat" method="post">
		<label for="id_cat">ID CAT    :</label>
		<input type="text" id="id_cat"  name="id_cat"><br>
		...
		<input list="jenis" name="id_jenis_cat" id="id_jenis_cat"><br>
