...
<body>
    ...
    <tr >
    	<th colspan="6">Detail Laporan Penjualan <?php echo $idnot; ?></th>
    </tr>
    <tr><th>No</th>
        <th>Nama cat</th>
        <th>Quantity</th>
    ...
    { ?>
    	<tr>
    		<td><?php echo $no ;?></td>
    		<td><?php echo $lap->nama_cat;?></td>
    		<td><?php echo $lap->quantity; ?></td>
    		<td><?php echo format_rp($lap->harga); ?></td>
    		<td align="right"><?php echo format_rp($lap->subtotal); ?></td>
    	</tr>
       
  <?php $total=$total+$lap->subtotal;
         $no++; };
    ?>
    <tr>
