...
<body>
    ...
    <tr >
    	<th colspan="6">Detail Laporan Penjualan Pada <?php echo $tgl; ?></th>
    </tr>
    <tr><th>No</th>
    ...
    { ?>
    	<tr>
    		<td><?php echo $no ;?></td>
    		<td><?php echo $lap->id_nota_penjualan ;?></td>
    		<td><?php echo $lap->nama_karyawan; ?></td>
    		<td><?php echo $lap->nama_pelanggan; ?></td>
    		<td align="right"><?php echo format_rp($lap->jumlah_penjualan); ?></td>
    		<td align="center"><?php echo anchor('lappenjualan/lapdetail/'.$lap->id_nota_penjualan,'Details'); ?></td>
    	</tr>
  ...
  <?php $total=$total+$lap->jumlah_penjualan;
    ...
    <tr>
    	...
    	<div class="">
    		<input class="cencel" type="button" value="kembali" onclick="javascript:history.go(-1);"/> 
    </div>
...
<div class="navbar">
	...
	<ul>
		...
		<hr style=""><br>
		<li class="dashboard"><i class="fas fa-cash-register"></i><a class="dashboard" href="transaksipenjualan.php" ><i></i>Transaksi</a></li>
